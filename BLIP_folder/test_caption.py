...
from folder.patch.folder import folderAttention
...
def main(args, config, r_value=40, alpha=1,beta=1,gamma=0, is_turbo=False):
    ...
    if r_value!=0:  
        if alpha!=0:
            folder.patch.folder(model.visual_encoder)
            ...
            model.visual_encoder.is_turbo = is_turbo
        else:
            folder.patch.folder_tome(model.visual_encoder)
            model.visual_encoder.r=r_value
...
if __name__ == '__main__':
    ...
    beta = args.beta
    gamma = args.gamma
    is_turbo = args.is_turbo
    main(args, config, r_value, alpha, beta, gamma, is_turbo)
    # main(args, config)